...
def cli_parser():
    ...
    sm_parser.add_argument("agent", action="store", choices=["open_source", "gpt4", "gpt4_alpaca_lora"], help="Agent type")

    args = sm_parser.parse_args()

    agent = args.agent
    agents = {"open_source": open_source_agent, "gpt4": openai_func_agent, "gpt4_alapca_lora": gpt4_te_alapca_lora_agent}
